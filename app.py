...
def main():
    ...
    zones = flask.request.args.get('zone')
    ...
    for zone in zone_list:
        try:
            zones_result = cf.zones.get(params={'name': zone})
            ...
            cfParams['type'] = 'A'
            a_records = cf.zones.dns_records.get(zones_result[0]['id'], params=cfParams)
            cfParams['type'] = 'AAAA'
            aaaa_records = cf.zones.dns_records.get(zones_result[0]['id'], params=cfParams)
            ...
            for a_record in a_records:
                ...
                if ipv4 is not None and a_record['content'] != ipv4:
                    cf.zones.dns_records.patch(zones_result[0]['id'], a_record['id'], data={'content': ipv4})
            ...
            for aaaa_record in aaaa_records:
                ...
                if ipv6 is not None and aaaa_record['content'] != ipv6:
                    cf.zones.dns_records.patch(zones_result[0]['id'], aaaa_record['id'], data={'content': ipv6})
